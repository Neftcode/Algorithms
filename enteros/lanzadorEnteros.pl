...
$path = "/home/{path}/Algorithms/enteros/"; #reemplazar {path} por la ruta donde se encuentra ubicado el proyecto (ej: /home/pedro/paralela/Algorithms/enteros/) IMPORTANTE: la ruta debe finalizar en /
